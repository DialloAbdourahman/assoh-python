...
# Allow the user to retry failed payments by simply generating a new payment url. 
# Maybe work on an admin route to retry a failed refund if a client complained. 